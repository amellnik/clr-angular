...
import { Directive, NgModule, EventEmitter, Input, Output, TemplateRef, ViewContainerRef, Optional, Injectable, ViewChild, Component, SkipSelf, forwardRef, ɵɵdefineInjectable, ContentChildren, QueryList, HostListener, ElementRef, Renderer2, HostBinding, InjectionToken, ContentChild, Inject, ComponentFactoryResolver, Self, Attribute, Injector, PLATFORM_ID, NgZone, LOCALE_ID, ChangeDetectorRef, IterableDiffers, ChangeDetectionStrategy } from '@angular/core';
...
import { first, filter, switchMap, map, take, tap, startWith, distinctUntilChanged } from 'rxjs/operators';
...
let ClrCommonStrings = class ClrCommonStrings {
};
ClrCommonStrings.ngInjectableDef = ɵɵdefineInjectable({ factory: function ClrCommonStrings_Factory() { return new ClrCommonStrings(); }, token: ClrCommonStrings, providedIn: "root" });
ClrCommonStrings = __decorate([
    Injectable(Object.assign({ providedIn: 'root' }, COMMON_STRINGS_PROVIDER))
], ClrCommonStrings);
...
ClrSignpostTrigger = __decorate([
     ...
     */
    ,
    __metadata("design:paramtypes", [IfOpenService, Renderer2, ElementRef])
], ClrSignpostTrigger);
